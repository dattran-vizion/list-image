...
export function createFourthLayout(width, height, offsetX, offsetY) {
  ...
  return [
    ...
    [box2Position, box2Scale],
    [box3Position, box3Scale],
    [box4Position, box4Scale],
    [box5Position, box5Scale],
  ];
}
...
export function createSixthLayout(width, height, offsetX, offsetY) {
  ...
  return [
    ...
    [box5Position, box5Scale],
    [box6Position, box6Scale],
    [box7Position, box7Scale],
    [box8Position, box8Scale],
  ];
}
